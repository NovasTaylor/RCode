...
#       Default query, loaded query can be edited prior to submission.
#       Visualize with visNetwork.
# SRC : 
# IN  : Load .TTL and .RQ from data subfolder.
# OUT :
# REQ :
# NOTE: Only works for queries that return s,p,o.
#       Loads of inelegant code, including hard coding of node styling
#       Easy to adjust to SPARQL endpoint from TTL. See rrdf docs for how.
#       rrdf can be a pain to configure (Java deps, not on CRAN). Consider
#          redland package as alternative.
